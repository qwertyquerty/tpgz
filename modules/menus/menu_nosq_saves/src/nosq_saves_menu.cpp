...
static Line lines[NOSQ_SAVES_COUNT] = {
    ...
    {"wormhole", NOSQ_WORMHOLE_INDEX, "Out of bounds swim to lakebed east outer main room"},
    ...
    {"poe gate clip", NOSQ_PGC_INDEX, "Clipping through the Arbiter's poe gate"},
    ...
    {"city gate clip", NOSQ_CGC_INDEX, "Clipping through the city gate before Aeralfos"},
...
void NoSQSavesMenu::draw() {
    ...
    if (GZ_getButtonTrig(SELECTION_BUTTON)) {
        special NoSQSpecials[] = {
            ...
            // special(NOSQ_KARG_INDEX, SaveMngSpecial_KargOoB, NULL),
            special(NOSQ_KB2_SKIP_INDEX, SaveMngSpecial_KB2Skip, NULL),
            special(NOSQ_ESCORT_INDEX, SaveMngSpecial_Escort, SaveMngSpecial_EscortKeys),
            special(NOSQ_LAKEBED_BK_SKIP_INDEX, SaveMngSpecial_LakebedBKSkip, NULL),
            special(NOSQ_MORPHEEL_INDEX, NULL, SaveMngSpecial_Morpheel),
            special(NOSQ_STALLORD_INDEX, SaveMngSpecial_BossFlags, SaveMngSpecial_Stallord),
            special(NOSQ_FRST_ESCAPE_INDEX, SaveMngSpecial_BossFlags, NULL),
            special(NOSQ_GORGE_VOID_INDEX, SaveMngSpecial_BossFlags, NULL),
            special(NOSQ_RUPEE_ROLL_INDEX, SaveMngSpecial_BossFlags, NULL),
            special(NOSQ_LANAYRU_GATE_CLIP_INDEX, SaveMngSpecial_BossFlags, NULL),
            special(NOSQ_LAKEBED_INDEX, SaveMngSpecial_BossFlags, NULL),
            // special(NOSQ_WATERFALL_SIDEHOP_INDEX, SaveMngSpecial_WaterfallSidehop, NULL),
            special(NOSQ_AERALFOS_SKIP_INDEX, NULL, SaveMngSpecial_NoSQAeralfos),
            // special(NOSQ_FAN_TOWER_INDEX, SaveMngSpecial_FanTower, NULL),
            special(NOSQ_ARGOROK_INDEX, SaveMngSpecial_Argorok, NULL),
            special(NOSQ_PALACE_1_INDEX, SaveMngSpecial_Palace1, NULL),
            // special(NOSQ_BEAST_GANON_INDEX, BeastGanonSpecial_setLayer, NULL),
        };
