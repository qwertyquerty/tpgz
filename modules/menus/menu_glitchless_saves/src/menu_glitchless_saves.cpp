...
static Line lines[GL_SAVES_NUM] = {
...
void GlitchlessSavesMenu::draw() {
    special GlitchlessSpecials[] = {
        special(GL_DANGORO_INDEX, NULL, SaveMngSpecial_Dangoro),
        special(GL_TOAD_INDEX, SaveMngSpecial_BossFlags, NULL),
        special(GL_DARKHAMMER_INDEX, SaveMngSpecial_BossFlags, NULL),
        special(GL_PALACE_INDEX, SaveMngSpecial_Palace1, NULL),
    };
