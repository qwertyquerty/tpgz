...
KEEP_FUNC AnyBiTESavesMenu::AnyBiTESavesMenu(Cursor& cursor)
    : Menu(cursor),
      lines{
          ...
          {"ordon gate clip", BITE_ORDON_GATE_CLIP_INDEX, "Gate Clip outside Ordon Spring"},
          {"back in time", BITE_BACK_IN_TIME_INDEX, "Back In Time off the Ordon Spring bridge"},
          {"seam clip", BITE_SEAM_CLIP_INDEX, "Epona Seam Clip in Hyrule Field South"},
          {"goats", BITE_GOATS_INDEX, "Goat herding 2"},
          {"sword and shield skip", BITE_HUGO_INDEX, "Hangin' with Hugo"},
          {"faron twilight", BITE_FARON_TWILIGHT_INDEX, "Faron Twilight tears"},
          {"early master sword", BITE_EMS_INDEX, "Super Jump to early Sacred Grove"},
          {"purple mist", BITE_MIST_INDEX, "Purple mist in Faron Woods (post-EMS)"},
          {"bite", BITE_BITE_INDEX, "Back in Time Equipped after Faron Twilight completion"},
          {"kb1", BITE_KB1_INDEX, "King Bulblin 1 Fight"},
          {"eldin twilight", BITE_ELDIN_TWILIGHT_INDEX, "Eldin Twilight tears"},
          {"bombhouse skip", BITE_BOMBHOUSE_SKIP_INDEX, "Jump from the bomb shop to the bombhouse"},
          {"epona oob", BITE_EPONA_OOB_INDEX, "Epona out of bounds to Lanayru"},
          {"karg fight", BITE_KARG_FIGHT_INDEX, "Fight the kargarok rider in Lake Hylia"},
          {"karg flight", BITE_KARG_FLIGHT_INDEX, "Fly the kargarok to Zora's Domain"},
          {"lanayru twilight", BITE_LANAYRU_TWILIGHT_INDEX, "Lanayru Twilight tears"},
          {"waterfall sidehop", BITE_WATERFALL_SIDEHOP_INDEX, "Waterfall sidehop after Rutela skip"},
          {"boss bug", BITE_BOSS_BUG_INDEX, "Lanayru Twilight boss bug"},
          {"iza", BITE_IZA_INDEX, "Steal Iza's bomb bag"},
          {"plumm oob", BITE_PLUMM_OOB_INDEX, "Bonk out of bounds and die in the Plumm minigame"},
          {"elh bomb boost", BITE_ENTER_LAKEBED_INDEX, "Bomb boost into Lakebed in an empty Lake Hylia"},
          {"lakebed 1", BITE_LAKEBED_1_INDEX, "Beginning of Lakebed Temple"},
          {"pot push", BITE_POT_PUSH_INDEX, "Use pots and the boomerang to get to Deku Toad early"},
          {"deku toad", BITE_TOAD_INDEX, "The miniboss of Lakebed Temple"},
          {"lakebed bk skip", BITE_LAKEBED_BK_SKIP_INDEX, "Boss Key skip in Lakebed Temple"},
          {"morpheel", BITE_MORPHEEL_INDEX, "Morpheel fight (no Zora Armor)"},
          {"mdh tower", BITE_MDH_TOWER_INDEX, "MDH tower climb before castle rooftops"},
          {"mdh bridge", BITE_MDH_BRIDGE_INDEX, "The falling bridge on castle rooftops"},
          {"messenger skip", BITE_MESSENGER_SKIP_INDEX, "Skip the Snowpeak portal with a Keese LJA"},
          {"snowpeak mbbb", BITE_SPR_MBBB_INDEX, "Moonboots bomb boost over the courtyard in Snowpeak"},
          {"freezard clip", BITE_SPR_FREEZARD_INDEX, "Clip through the door behind freezard"},
          {"dark hammer", BITE_DARK_HAMMER_INDEX, "The Snowpeak Ruins miniboss"},            
          {"bulblin camp", BITE_BULBLIN_CAMP_INDEX, "The area before Arbiter's Grounds"},
          {"arbiter's grounds", BITE_AG_INDEX, "The Arbiter's Grounds segment"},
          {"poe gate clip", BITE_PGC_INDEX, "Clipping through the Arbiter's poe gate"},
          {"early boss key", BITE_EARLY_BOSS_KEY_INDEX, "The clip to get the big key early in Arbiter's Grounds"},
          {"death sword", BITE_DSS_INDEX, "The Arbiter's Grounds miniboss"},
          {"stallord", BITE_STALLORD_INDEX, "The Arbiter's Grounds boss"},
          {"stallord 2", BITE_STALLORD2_INDEX, "Stallord 2nd phase"},
          {"city in the sky early", BITE_CITS_EARLY_INDEX, "Clip to the sky cannon early"},
          {"city in the sky 1", BITE_CITS_1_INDEX, "The first City in the Sky segment"},
          {"city gate clip", BITE_CGC_INDEX, "Clipping through the city gate before Aeralfos"},
          {"aeralfos skip", BITE_AERALFOS_SKIP_INDEX, "The City in the Sky miniboss"},
          {"city in the sky 2", BITE_CITS_2_INDEX, "The second City in the Sky segment"},
          {"fan tower", BITE_FAN_TOWER_INDEX, "Final fan room in CitS before the boss"},
          {"argorok", BITE_ARGOROK_INDEX, "The City in the Sky boss"},
          {"sol 1", BITE_PALACE_SOL_1_INDEX, "The first sol segment of Palace of Twilight"},
          {"sol 2", BITE_PALACE_SOL_2_INDEX, "The second sol segment of Palace of Twilight"},
          {"after light sword", BITE_PALACE_2_INDEX, "The Palace of Twilight segment after Light Sword"},
          {"pot bk room", BITE_PALACE_BK_INDEX, "The big key room in Palace of Twilight"},
          {"early platform", BITE_EARLY_PLATFORM_INDEX, "Early platform cycle in Palace of Twilight"},
          {"zant", BITE_ZANT_INDEX, "The Palace of Twilight boss"},
          {"hyrule castle", BITE_HC_INDEX, "The Hyrule Castle segment"},
          {"kb4", BITE_KB4_INDEX, "The King Bulblin fight in Hyrule Castle"},
          {"darknut fight", BITE_DARKNUT_INDEX, "The Darknut fight in Hyrule Castle"},
          {"hc aeralfos", BITE_HC_AERALFOS_INDEX, "The Aeralfos fight in Hyrule Castle"},
          {"final tower climb", BITE_HC_TOWER_INDEX, "The tower climb before the final boss fights"},
          {"beast ganon", BITE_BEAST_GANON_INDEX, "The Beast Ganon fight"},
          {"horseback ganon", BITE_HORSEBACK_GANON_INDEX, "The horseback Ganondorf fight"},
#endif
      } {}
...
void AnyBiTESavesMenu::draw() {
    ...
    if (GZ_getButtonTrig(SELECTION_BUTTON)) {
        special AnySpecials[] = {
            ...
            special(BITE_KARG_FLIGHT_INDEX, SaveMngSpecial_KargOoB, nullptr),
#ifdef GCN_PLATFORM
